...
asal_daerah = st.pills("Asal Daerah", ["Medan", "California", "Malang"], default="California" )
warna = st.pills("Warna", ["Hijau pekat","Kuning kehijauan","Kuning cerah"], default="Hijau pekat")
musim_panen = st.pills("Musim Panen", ["Puncak","Akhir","Awal"], default="Awal")
...
st.divider()
st.caption("Dibuat dengan :tangerine: oleh **Aden gans**")